...
$(document).ready(function() { 
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <fieldset>
                                                <button type="button" class="btn" data-toggle="modal" style="background: rgb(23, 177, 23);"
                                                    data-target="#addpositionnewempleo" onclick="sendid('${"coordsmodal"+doc.id}','${"inputdireccionempleados"+doc.id}','${ {lat: parseFloat(doc.data().coordenadas.Latitud), lng: parseFloat(doc.data().coordenadas.Longitud)}}')"><i class="fa fa-map-marker" aria-hidden="true"></i>
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(function(position) {  
            ...
            setdireccion(latlng,'direccionnuevotrabajo');
        }, function(error) {  
