                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <fieldset>
                                                <button type="button" class="btn" data-toggle="modal" style="background: rgb(23, 177, 23);"
                                                    data-target="#addpositionnewempleo" onclick="sendid('${"coordsmodal"+doc.id}','${"inputdireccionempleados"+doc.id}','${parseFloat(doc.data().coordenadas.Latitud)}','${parseFloat(doc.data().coordenadas.Longitud)}')"><i class="fa fa-map-marker" aria-hidden="true"></i>
